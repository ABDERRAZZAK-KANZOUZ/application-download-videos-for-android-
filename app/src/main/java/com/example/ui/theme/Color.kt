...
// Bold Typography - Light Theme Palette (Exact hex values from custom HTML spec)
...
// Surface containers defining rounded Material 3 elevation surfaces
val SurfaceContainer = Color(0xFFF3EDF7)
val SurfaceContainerLow = Color(0xFFF7F2FA)
val SurfaceContainerHigh = Color(0xFFECE6F0)

// Bold Typography - Dark Theme Palette (High-contrast matching variant for premium dark mode)
